...
Scenario: sort movies alphabetically
  ...
  And I should see "Chicken Run" before "When Harry Met Sally" in the movie list
...
Scenario: sort movies in increasing order of release date
  ...
  And I should see "The Terminator" before "Aladdin" in the movie list
  And I should see "Aladdin" before "The Help" in the movie list
